...
export default function MainTen({navigation}){
    ...
    const getProps = () => {
        fetch(`http://192.168.0.26:8080/prop`, () => method='GET')
    ...
    return (
        <TouchableWithoutFeedback onPress={() => {
          ...
          <View style={styles.container}>
              ...
              <ScrollView>
                {props.map(prop => (
                <TouchableOpacity key={prop._id} onPress={() => navigation.navigate('PropDetailsBuy', {prop: prop, user: user})}>
